<%-- 
    Document   : enquiries
    Created on : 12 May, 2024, 4:47:39 PM
    Author     : acer
--%>
...
<html>
    <head>
        ...
        <title>Digital HR - Enquiries</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                    <div class="col-sm-12" style="background-color: yellow; min-height: 600px;">
                        <h2 style="color: blue; font-family: poppins; text-align: center; padding-top: 30px;">Customers Enquiries</h2>
