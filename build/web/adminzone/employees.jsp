<%-- 
    Document   : employees
    Created on : 17 May, 2024, 2:44:10 AM
    Author     : acer
--%>
             ...
             <div id="body" class="container-fluid overflow-y-auto">
                <div class="row">
                    <div class="col-sm-12 mx-auto p-3">
                        <h2 style="color: blue; font-weight: bold; font-family: poppins; text-align: center; padding-top: 30px;" class="mb-3">Employees Information</h2>
                    <table class="table table-bordered" style="width: 95%; margin: auto;">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="delemployee.jsp?empid=<%=rs.getInt("empid")%>">
                                    <button type="button" class="btn btn-danger fw-semibold">Delete</button>
                                </a>
                                    <a href="editemployee.jsp?empid=<%=rs.getInt("empid")%>">
                                    <button type="button" class="btn btn-success fw-semibold">Edit</button>
                                </a>
                            </td>
                        </tr>
                        <% } %>
